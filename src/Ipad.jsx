        ...
        <>
            <div class = "bg-gray-100 w-full h-145 overflow-hidden flex flex-col items-center mt-3">
                <div class = "absolute pt-[40px] flex flex-col items-center gap-3 overflow-hidden">
                    <h1 class = "text-3xl md:text-4xl lg:text-5xl text-white font-semibold">iPad Pro</h1>
                    <p class = "text-xl md:text-2xl lg:text-3xl text-white font-light">Ubelievably thin. Incredibly powerful.</p>
                    ...
                    <p class = "mt-72 mb-4 text-base md:text-lg lg:text-xl font-medium bg-gradient-to-r from-blue-500 via-purple-500 to-orange-500 bg-clip-text text-transparent">Built for Apple Intelligence.</p>
                </div>
